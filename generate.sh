...
# curl -H 'Cache-Control: no-cache' https://raw.githubusercontent.com/PolyProgrammist/nearcore/refs/heads/openapi-errors/chain/jsonrpc/openapi/openapi.json > openapi.json
